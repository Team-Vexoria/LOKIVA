...
const CURATED_LANDING_EXPERIENCES: Experience[] = [
  ...
  } as Experience,
  {
    ...
    review_count: 360,
    approx_duration_mins: 60,
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Haji_Ali_Dargah_Mumbai.jpg/1280px-Haji_Ali_Dargah_Mumbai.jpg',
    image_urls: ['https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Haji_Ali_Dargah_Mumbai.jpg/1280px-Haji_Ali_Dargah_Mumbai.jpg'],
    is_active: true,
    is_family_friendly: true,
    wheelchair_accessible: false,
  ...
  } as Experience,
  {
    ...
    tagline: 'Premier Indo-Saracenic art and historical museum with world-class collections and royal gardens',
    category: 'Heritage & History',
    city: 'Mumbai',
    state: 'Maharashtra',
    area_name: 'Fort / Kala Ghoda, South Mumbai',
    price: 150,
    rating: 4.92,
    review_count: 340,
    approx_duration_mins: 120,
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Prince_of_Wales_Museum%2C_Mumbai.jpg/1280px-Prince_of_Wales_Museum%2C_Mumbai.jpg',
    image_urls: ['https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Prince_of_Wales_Museum%2C_Mumbai.jpg/1280px-Prince_of_Wales_Museum%2C_Mumbai.jpg'],
    is_active: true,
    is_family_friendly: true,
    wheelchair_accessible: true,
    tags: ['museum', 'art', 'history', 'mumbai'],
  } as Experience,
];
