      ...
      <div className="flex flex-col items-center justify-center space-y-4 pt-2">
        ...
        <div className="flex items-center gap-4 pt-1">
          ...
          <a
            ...
            className="w-10 h-10 rounded-full bg-white border border-[#DDD7CC] hover:border-[#FFC067] text-[#12213B] hover:text-[#FFC067] shadow-2xs flex items-center justify-center transition-all hover:scale-110 cursor-pointer"
          >
        ...
        <div className="pt-2 flex flex-wrap items-center justify-center gap-x-3 gap-y-1.5 text-xs sm:text-sm font-mono font-bold text-[#12213B] tracking-wide">
          ...
          <span className="text-[#FFC067]">·</span>
          <span className="hover:text-[#FFC067] transition-colors cursor-pointer">#traveltogether</span>
          <span className="text-[#FFC067]">·</span>
