...
export function Navbar() {
  ...
  return (
    <header className="fixed top-2 sm:top-3 inset-x-0 z-50 pointer-events-none px-3 sm:px-6">
      {/* Floating capsule nav with ultra-smooth Framer Motion spring/ease interpolation */}
      <motion.nav
        animate={{
          maxWidth: isScrolled ? 800 : 960,
          ...
          borderColor: isScrolled ? '#D0D7CF' : '#D0D7CF',
      ...
      >
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex-1 flex items-center justify-start">
            <Link to="/" className="flex items-center gap-2 group flex-shrink-0">
              <motion.img
                src="/logo.png"
                alt="LOKIVA"
                animate={{ height: isScrolled ? 22 : 26 }}
          ...
          <div className="hidden md:flex items-center justify-center gap-1.5 lg:gap-2.5 flex-shrink-0">
