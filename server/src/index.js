...
app.get('/health', (req, res) => {
  res.json({ status: 'ok', destination: 'Jaipur' });
});
...
async function startServer() {
  ...
  app.listen(PORT, () => {
    console.log(`\n======================================================`);
    console.log(`🚀 LOKIVA Node.js API server running on http://localhost:${PORT}`);
...
startServer().catch((err) => {
  console.error('Failed to start LOKIVA server:', err);
});
